...
![screenshot showing an example profile readme](https://github.com/Wang6409/skills-introduction-to-github/blob/main/.github/images/example-profile-readme.png?raw=true)
...
2. Navigate to the **< > Code** tab in the header menu of your repository.
   ...
   ![screenshot highlighting the code tab](https://github.com/Wang6409/skills-introduction-to-github/blob/main/.github/images/code-tab-highlight.png?raw=true)

3. Click on the **main** branch drop-down.

   <img width="300" alt="screenshot highlighting the branch selection" src="https://github.com/Wang6409/skills-introduction-to-github/blob/main/.github/images/branch-selection-dropdown.png?raw=true">
...
5. Click the text **Create branch: `my-first-branch` from main** to create your branch.
   ...
   <img width="300" alt="screenshot highlighting the create branch prompt" src="https://github.com/Wang6409/skills-introduction-to-github/blob/main/.github/images/create-branch-prompt.png?raw=true">
